...
// THIS FILE IS GENERATED. DO NOT EDIT, OTHERWISE CHANGES WILL BE OVERWRITTEN. CHANGE Package@swift-6.5.swift.template INSTEAD.
...
let package = Package(
    ...
    targets: hostOnlyTests ? [
        ...
        .executableTarget(
            ...
            dependencies: ["TestInDeviceCore"],
            // This executable is a host-side command-plugin tool. Do not add an
            // Apple platform floor to CPicoSDK: its library targets are
            // cross-compiled for bare-metal devices.
            swiftSettings: [
                .unsafeFlags([
                    "-Xfrontend",
